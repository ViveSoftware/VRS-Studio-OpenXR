...
{
    public class FacialExpressionEdgeDragHelper : EdgeDragHelper
    {
        ...
        protected Dictionary<FacialTrackingGraphNode, List<FacialExpressionPortView>> compatiblePorts = new Dictionary<FacialTrackingGraphNode, List<FacialExpressionPortView>>();
        ...
        public FacialExpressionEdgeDragHelper(IEdgeConnectorListener listener)
        {
        ...
        {
            //Debug.Log("BaseEdgeDragHelper Reset()");
            ...
            {
                var pv = ghostEdge.input as FacialExpressionPortView;
        ...
        {
            //Debug.Log("BaseEdgeDragHelper HandleMouseDown()");
            ...
            foreach (FacialExpressionPortView port in graphView.GetCompatiblePorts(draggedPort, nodeAdapter))
            {
                compatiblePorts.TryGetValue(port.owner, out var portList);
                if (portList == null)
                    portList = compatiblePorts[port.owner] = new List<FacialExpressionPortView>();
                portList.Add(port);
            }
        ...
        {
            //Debug.Log("BaseEdgeDragHelper GetEffectivePanSpeed()");
        ...
        {
            //Debug.Log("BaseEdgeDragHelper HandleMouseMove()");
        ...
        {
            //Debug.Log("BaseEdgeDragHelper CreateEdgeView()");
            return new EdgeView();
        }

        private void Pan(TimerState ts)
        {
            //Debug.Log("BaseEdgeDragHelper Pan()");
        ...
        {
            //Debug.Log("BaseEdgeDragHelper HandleMouseUp()");
        ...
        Rect GetPortBounds(FacialTrackingGraphNode nodeView, int index, List<FacialExpressionPortView> portList)
        {
            //Debug.Log("BaseEdgeDragHelper GetPortBounds()");
        ...
        {
            //Debug.Log("BaseEdgeDragHelper GetEndPort()");
            if (graphView == null)
                return null;
